...
export const projects: Project[] = [
  {
    ...
    screenshots: shotPaths('galata', 36),
    ...
    copy: {
      en: {
        ...
        staffFeatures: [
          'Staff sign-in with protected access',
          ...
          'Push notifications for reservations, chat, and floor events',
        ],
        highlights: [
          ...
          'Store-ready privacy policy for App Store / Google Play',
      ...
      tr: {
        ...
        staffFeatures: [
          ...
          'Rezervasyon, sohbet ve salon olayları için bildirimler',
        ],
        highlights: [
          ...
          'App Store / Play için gizlilik politikası',
      ...
      ru: {
        ...
        staffFeatures: [
          ...
          'Push-уведомления — брони, чат и события зала',
        ],
        highlights: [
          ...
          'Политика конфиденциальности для App Store / Google Play',
          'Expo (React Native), TypeScript, Supabase',
        ],
      },
      az: {
        ...
        staffFeatures: [
          ...
          'Push bildirişləri — rezervasiya, çat və zal hadisələri',
        ],
        highlights: [
          ...
          'App Store / Play üçün məxfilik siyasəti',
          'Expo (React Native), TypeScript, Supabase',
        ],
      },
    },
  ...
  },
  {
    ...
    screenshots: shotPaths('converter', 17),
