...
export const projects: Project[] = [
  {
    ...
    screenshots: shotPaths('galata', 39),
    featured: true,
    accent: '#c45c26',
    copy: {
      en: {
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        blurb:
          'Converter combines live FX, crypto rates, and physical unit conversions with an expression keypad, 13 languages including RTL, and a responsive phone/tablet layout.',
        cardBullets: [
          'Live FX & crypto',
          'Length, weight, temp…',
        ...
        features: [
          'Live currency converter with customizable currency list',
          'Cryptocurrency rates with offline coin icons',
          'Length, weight, temperature, volume, area, speed, and time conversion',
          'Expression calculator keypad with instant results',
          '13 languages including RTL (Arabic)',
          'Language onboarding on first launch',
          'Scene-based UI with glass and solid card styles',
          'Per-tab keypad state with local persistence',
          'Add / remove currencies and units',
          'Responsive layout for phone and tablet',
          'Built with Expo, React Native, and TypeScript',
        ],
      },
      tr: {
        tagline: 'Canlı döviz, kripto ve birim dönüşümü — sahne tabanlı hesap makinesi arayüzü.',
        blurb:
          'Converter; canlı döviz, kripto kurları ve fiziksel birim dönüşümlerini anlık keypad, Arapça dahil 13 dil (RTL) ve telefon/tablet uyumlu düzenle birleştirir.',
        cardBullets: [
          'Canlı döviz & kripto',
        ...
        features: [
          'Canlı döviz çevirici ve özelleştirilebilir para birimi listesi',
          'Kripto kurları ve çevrimdışı coin ikonları',
          'Uzunluk, ağırlık, sıcaklık, hacim, alan, hız ve zaman dönüşümü',
          'Anlık sonuç veren hesap makinesi tuş takımı',
          'Arapça dahil 13 dil desteği (RTL)',
          'İlk açılışta dil seçim ekranı',
          'Cam ve solid kart stilleriyle sahne tabanlı arayüz',
          'Sekme başına keypad durumu ve yerel kayıt',
          'Para birimi / birim ekleme ve kaldırma',
          'Telefon ve tablet için duyarlı düzen',
          'Expo, React Native ve TypeScript ile geliştirildi',
        ],
      },
      ru: {
        tagline: 'Живые валюты, крипто и единицы измерения с калькулятором на сценах.',
        blurb:
          'Converter объединяет курсы валют и крипты, физические конвертации, калькулятор с мгновенным результатом, 13 языков включая RTL и адаптив для телефона/планшета.',
        cardBullets: [
          'Валюты и крипто',
          'Длина, вес, температура…',
          'Калькулятор выражений',
          '13 языков + RTL',
          'Стекло / solid сцены',
        ],
        features: [
          'Конвертер валют в реальном времени с настраиваемым списком',
          'Курсы криптовалют и офлайн-иконки монет',
          'Конвертация длины, веса, температуры, объёма, площади, скорости и времени',
          'Калькулятор с мгновенным результатом',
          'Поддержка 13 языков, включая RTL (арабский)',
          'Выбор языка при первом запуске',
          'Интерфейс со сценами, стеклянными и сплошными карточками',
          'Отдельное состояние клавиатуры на каждой вкладке с локальным сохранением',
          'Добавление и удаление валют и единиц',
          'Адаптивная вёрстка для телефона и планшета',
          'Сделано на Expo, React Native и TypeScript',
        ],
      },
      az: {
        tagline: 'Canlı valyuta, krypto və vahid çevrilməsi — səhnə əsaslı kalkulyator interfeysi.',
        blurb:
          'Converter; canlı valyuta, krypto kursları və fiziki vahid çevrilmələrini anlıq keypad, ərəb dili daxil 13 dil (RTL) və telefon/planşet uyğun düzülüşlə birləşdirir.',
        cardBullets: [
          'Canlı valyuta və krypto',
          'Uzunluq, çəki, temperatur…',
          'İfadə kalkulyatoru',
          '13 dil + RTL',
          'Şüşə / solid səhnələr',
        ],
        features: [
          'Canlı valyuta çeviricisi və fərdiləşdirilə bilən valyuta siyahısı',
          'Krypto kursları və oflayn coin ikonları',
          'Uzunluq, çəki, temperatur, həcm, sahə, sürət və vaxt çevrilməsi',
          'Anlıq nəticə verən kalkulyator düymə paneli',
          'Ərəb dili daxil 13 dil dəstəyi (RTL)',
          'İlk açılışda dil seçim ekranı',
          'Şüşə və solid kart stilləri ilə səhnə əsaslı interfeys',
          'Tab üzrə keypad vəziyyəti və lokal yadda saxlama',
          'Valyuta / vahid əlavə etmə və silmə',
          'Telefon və planşet üçün responsive düzülüş',
          'Expo, React Native və TypeScript ilə hazırlanıb',
        ],
      },
    },
  },
